      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="hidden xl:flex flex-1 relative">
            <DevImg
              containerStyles="bg-about_shape_light dark:bg-about-shape-dark w-[505px] 
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-4">
                      Up and Coming React Web Developer
                    </h3>
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      I have spent the last 2 years crafting intuitive websites
                              ...
                              return (
                                <div className="flex gap-x-8 group" key={index}>
                                  <div className="h-[84px] w-[1px] bg-border relative ml-2">
                                    <div
                                      className="h-[11px] w-[11px] bg-primary absolute -left-[5px] rounded-full 
