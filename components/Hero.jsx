    ...
    >
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          {/* text */}
          <div
            className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center
          xl:text-left"
          >
            ...
            <p className="subtitle max-w-[490px] mx-auto xl:m-0">
              Freenlance Web Developer, always open to new challenges and ideas
              to work on. Let's create something awesome together!
            </p>
            {/* buttons */}
            <div
